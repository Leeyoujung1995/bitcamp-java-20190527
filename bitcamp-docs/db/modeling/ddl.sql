...
-- 강사강의배정
DROP TABLE IF EXISTS lecture teacher RESTRICT;
...
-- 강사강의배정
ALTER TABLE lecture teacher
  ADD CONSTRAINT PK_lecture teacher -- 강사강의배정 기본키
    PRIMARY KEY (
      lecture_id, -- 강의번호
      teacher_id  -- 강사번호
    );
...
-- 강사강의배정
ALTER TABLE lecture teacher
  ADD CONSTRAINT FK_teachers_TO_lecture teacher -- 강사 -> 강사강의배정
    FOREIGN KEY (
      teacher_id -- 강사번호
    )
    REFERENCES teachers ( -- 강사
...
-- 강사강의배정
ALTER TABLE lecture teacher
  ADD CONSTRAINT FK_lectures_TO_lecture teacher -- 강의 -> 강사강의배정
    FOREIGN KEY (
      lecture_id -- 강의번호
    )
    REFERENCES lectures ( -- 강의
