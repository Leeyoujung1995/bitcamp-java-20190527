...
public void updateLesson() {
  ...
  lesson.setEndDate( input.getDateValue("종료일(" +lesson.getStartDate()+")?"));
 
  lesson.setTotalHours(input.getIntValue("총수업시간(" +lesson.getStartDate()+")?"));
  
  lesson.setDayHours( input.getIntValue("일수업시간(" +lesson.getStartDate()+")?"));
