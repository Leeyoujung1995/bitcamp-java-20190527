...
public class Test02 {
  public static void main(String[] args) {
    ...
    s2.setName("이유정");
    s2.setMusic(100);//Score2 compute2()호출 =>5과목의 합계와 평균 계산
    s2.setArt(100);//Score2 compute2()호출=>5과목의 합계와 평균 계산
    s2.setKor(100);//Score compute()호출=>3과목의 합계와 평균 계산
    s2.setEng(100);//Score compute()호출=>3과목의 합계와 평균 계산
    s2.setMath(100);//Score compute()호출=>3과목의 합계와 평균 계산
