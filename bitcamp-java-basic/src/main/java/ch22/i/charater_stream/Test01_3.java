//스트링 버퍼에 출력할 때- Stream API를 사용하여 데이터 출력하기
...
public class Test01_3 {
  public static void main(String[] args) throws Exception {
    ...
    //Test1_1.java와 Test01_2.java에서 문자를 출력하는 방법이 다르다
    //스트링 버퍼에 출력할 떄는 스트링 버퍼를 직접 다룬다
    //그러나 파일에 출력할 때는 Stream API를 사용한다
    //그래서 데이터를 출력할 때 일관성이 없다 .즉 유지보수가 불편하다
    //이를 해결하기 위해 나온 방법이
    //메모리(스티링 버퍼)에 출력할 떄도 Streaming API를 사용하는 것이다
