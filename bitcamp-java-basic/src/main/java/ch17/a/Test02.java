...
public class Test02 {
  ...
  public static void main(String[] args) {
    ...
    obj4.m1();//m1()은 A 클래스에 있는 메서드이다.호출할 수 있다.
              //다만 obj4 저장된 인스턴스(주소)는 실제 My2 클래스이기 때문에
              //m1() 메서드를 찾을 때는 My2 클래스부터 상위 클래스로 찾아 올라간다.
    obj4.m2("임꺽정");//m2()또한 m1()과 같다.
    //obj4.m3();//obj4는 A클래스의 래퍼런스이기 떄문에 문법적으로 m3()메서드가 없어서 호출할 수 없다/
    ...
    //obj4에 My2 인스턴스를 저장한 것이 확실하다면 컴파일러에게 개발자가 직접 알려줘야한다
