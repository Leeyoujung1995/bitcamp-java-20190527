...
public class Test01 {
  ...
  static void display(Sorter sorter, int[] values) {
   ...
   //어? Sorter 클래스의 sort() 메서드는 추상 메서드인데
    //어떻게 호출할 수 있나요? 다음 코드는 오류가 아닌가요?
    //=>JYM이 sort()를 호출할 때 레퍼런스에 있는 객체가 실제 어떤 클래스이 객체인지 판단한다.
