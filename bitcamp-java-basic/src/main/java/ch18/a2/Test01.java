...
public class Test01 {
  ...
  public static void main(String[] args) {
   //인터페이스 레퍼런스 선언
    ...
    //이 클래스의 인스턴스 주소를 tool 래퍼런스 변수에 저장할 수 있다.
    tool = new ToolA();
    
    //ToolB 클래스도 ToolA와 마찬가지로 Spec 규현체(implementer;인터페이스 규칙에 따라 만든 클래스)이기 떄문에
    //해당 객체를 저장할 수 있다
    tool = new ToolB();
    
    //String 클래스는 Spec 구현체가 아니기 떄문에 해당 객체를 레퍼런스에 저장할  수 없
