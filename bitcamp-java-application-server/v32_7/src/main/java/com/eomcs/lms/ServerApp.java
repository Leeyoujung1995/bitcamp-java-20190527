 ...
 Lesson lesson = (Lesson)in.readObject();
    ...
    for (Lesson l :lessonList) {
      if (l.getNo() == lesson.getNo()) {
       ...
       l.setContents(lesson.getContents());
       l.setStartDate(lesson.getStartDate());
       l.setEndDate(lesson.getEndDate());
       l.setTotalHours(lesson.getTotalHours());
       l.setDayHours(lesson.getDayHours());
        out.writeUTF("ok");
        return;
      }
    }
    ...
    Board board = (Board)in.readObject();
       ...
       for (Board b :boardList) {
         if (b.getNo() == board.getNo()) {
          ...
          b.setCreatedDate(board.getCreatedDate());
          b.setViewCount(board.getViewCount());
           out.writeUTF("ok");
           return;
         }
       }
