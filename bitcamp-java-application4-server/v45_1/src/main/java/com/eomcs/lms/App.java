// v45_1: Jva Proxy를 이용하여 Dao구현체 자동생성하기
...
public class App {
  ...
  public App() throws Exception {
    ...
    try {
      ...
      BoardDao boardDao = daoFactory.creatDao(BoardDao.class);
      LessonDao lessonDao = daoFactory.creatDao(LessonDao.class);
      MemberDao memberDao = daoFactory.creatDao(MemberDao.class);
      PhotoBoardDao photoBoardDao = daoFactory.creatDao(PhotoBoardDao.class);
      PhotoFileDao photoFileDao = daoFactory.creatDao(PhotoFileDao.class);
