...
public class ConnectionFactory {
  ...
  //스레드 별로 커넥션 객체를 사용하기 위해  현재  스레드의 값을 넣고 꺼낼 수 있는 도구를 준비한다.
  ...
  public void clearConnection() {
    Connection con = localConnection.get();
    if(con != null) {
      try {((TxConnection)con).realClose();}catch(Exception e) {}
